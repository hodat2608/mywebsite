...
urlpatterns = [
    ...
    re_path(r'^(?P<musician_id>[0-9]+)/song_detail/$', views.song_detail, name='song_detail'), 
    re_path(r'^(?P<musician_id>[0-9]+)/fix_lyrics/$', views.update_song_lyrics, name='update_song_lyrics'), 
